...
export const researchGuidanceContent: Record<string, GuidanceContent> = {
  title: {
    icon: React.createElement(Microscope, { className: 'w-5 h-5 text-fg-primary' }),
  ...
  field: {
    icon: React.createElement(FlaskConical, { className: 'w-5 h-5 text-fg-primary' }),
  ...
  voting_enabled: {
    icon: React.createElement(Vote, { className: 'w-5 h-5 text-fg-primary' }),
...
export const researchDefaultGuidance: DefaultGuidance = {
  ...
  features: [
    {
      icon: React.createElement(Microscope, { className: 'w-4 h-4 text-fg-primary' }),
