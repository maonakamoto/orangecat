...
export const projectGuidanceContent: Record<NonNullable<ProjectFieldType>, GuidanceContent> = {
  title: {
    icon: React.createElement(Rocket, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Project Title',
    description:
  ...
  website_url: {
    icon: React.createElement(ExternalLink, { className: 'w-5 h-5 text-fg-primary' }),
...
export const projectDefaultGuidance: DefaultGuidance = {
  ...
  features: [
    ...
    {
      icon: React.createElement(ExternalLink, { className: 'w-4 h-4 text-fg-primary' }),
    ...
    {
      icon: React.createElement(Rocket, { className: 'w-4 h-4 text-fg-primary' }),
