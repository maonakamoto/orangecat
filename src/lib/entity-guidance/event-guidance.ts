...
export const eventGuidanceContent: Record<NonNullable<EventFieldType>, GuidanceContent> = {
  title: {
    icon: React.createElement(Calendar, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Event Title',
  ...
  venue_name: {
    icon: React.createElement(Building, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Venue Name',
  ...
  is_online: {
    icon: React.createElement(Globe, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Online Event',
  ...
  max_attendees: {
    icon: React.createElement(Users, { className: 'w-5 h-5 text-fg-primary' }),
  ...
  requires_rsvp: {
    icon: React.createElement(CheckCircle2, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Requires RSVP',
  ...
  ticket_price: {
    icon: React.createElement(Ticket, { className: 'w-5 h-5 text-fg-primary' }),
    title: 'Ticket Price',
    description:
    ...
    examples: [
      'CHF 50 - Small meetup',
      'CHF 200 - Workshop with materials',
  ...
  funding_goal: {
    ...
    tips: [
      ...
      'Fiat goals (CHF/EUR/USD) can be reached via funding OR Bitcoin price appreciation',
      'BTC goals can only be reached via funding',
...
export const eventDefaultGuidance: DefaultGuidance = {
  ...
  features: [
    {
      icon: React.createElement(Calendar, { className: 'w-4 h-4 text-fg-primary' }),
    ...
    {
      icon: React.createElement(Ticket, { className: 'w-4 h-4 text-fg-primary' }),
      text: 'Sell tickets with Bitcoin',
    },
    {
      icon: React.createElement(Building, { className: 'w-4 h-4 text-fg-primary' }),
