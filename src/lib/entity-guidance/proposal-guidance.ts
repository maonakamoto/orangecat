...
export const proposalGuidanceContent: Record<NonNullable<ProposalFieldType>, GuidanceContent> = {
  ...
  voting_threshold: {
    icon: React.createElement(Percent, { className: 'w-5 h-5 text-fg-primary' }),
...
export const proposalDefaultGuidance: DefaultGuidance = {
  ...
  features: [
    ...
    {
      icon: React.createElement(Lightbulb, { className: 'w-4 h-4 text-fg-primary' }),
    ...
    {
      icon: React.createElement(FileText, { className: 'w-4 h-4 text-fg-primary' }),
