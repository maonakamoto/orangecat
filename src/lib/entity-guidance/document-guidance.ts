...
export const documentGuidanceContent: Record<NonNullable<DocumentFieldType>, GuidanceContent> = {
  ...
  content: {
    icon: React.createElement(StickyNote, { className: 'w-5 h-5 text-tiffany-600' }),
...
export const documentDefaultGuidance: DefaultGuidance = {
  ...
  features: [
    ...
    {
      icon: React.createElement(Wrench, { className: 'w-4 h-4 text-tiffany-600' }),
    ...
    {
      icon: React.createElement(Cat, { className: 'w-4 h-4 text-tiffany-600' }),
