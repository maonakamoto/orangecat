    ...
    >
      <div className="max-w-lg w-full space-y-8 p-6 bg-card rounded-xl shadow-xl border border-orange-100 dark:border-border">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => router.back()}
            className="group relative w-full flex justify-center items-center gap-2 py-3 px-4 border border-gray-300 dark:border-border text-sm font-medium rounded-md text-foreground bg-card hover:bg-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors"
          >
