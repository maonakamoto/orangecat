    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 dark:border-border text-foreground bg-card hover:bg-muted transition-colors"
        >
