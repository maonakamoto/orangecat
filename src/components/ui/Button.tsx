...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      ghost:
        'hover:bg-muted hover:text-gray-900 dark:hover:text-foreground focus-visible:ring-gray-500 shadow-none hover:shadow-sm text-muted-strong',
      danger:
      ...
      outline:
        'border-2 border-border-strong bg-transparent hover:bg-muted hover:border-gray-400 focus-visible:ring-gray-500 shadow-sm hover:shadow-button active:shadow-sm text-foreground',
