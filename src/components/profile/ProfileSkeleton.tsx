...
export function WalletsSkeleton() {
  return (
    <div className="space-y-4">
      <div className="h-6 w-48 bg-gray-200 dark:bg-muted rounded animate-pulse" />
        ...
        {[1, 2].map(i => (
          ...
          >
            <div className="flex items-start gap-3 mb-4">
              <div className="w-12 h-12 bg-gray-200 dark:bg-muted rounded animate-pulse" />
            ...
            <div className="bg-gray-50 dark:bg-muted rounded-lg p-3 mb-3">
              ...
              <div className="h-6 w-40 bg-gray-200 dark:bg-muted rounded animate-pulse" />
            </div>
            <div className="h-2 w-full bg-gray-200 dark:bg-muted rounded animate-pulse mb-3" />
            <div className="h-16 w-full bg-gray-100 dark:bg-muted rounded animate-pulse" />
          </div>
        ))}
      </div>
    </div>
          ...
          <div key={i} className="rounded-xl border-2 border-border bg-card overflow-hidden">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex-1 p-4 sm:p-5">
                <div className="h-6 w-3/4 bg-gray-200 dark:bg-muted rounded animate-pulse mb-3" />
                <div className="h-4 w-full bg-gray-200 dark:bg-muted rounded animate-pulse mb-2" />
                <div className="h-4 w-5/6 bg-gray-200 dark:bg-muted rounded animate-pulse mb-4" />
                <div className="h-2 w-full bg-gray-200 dark:bg-muted rounded animate-pulse mb-2" />
    ...
    <div className={`min-h-screen ${GRADIENTS.graySubtle}`}>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="relative mb-8">
          <div className="relative h-48 sm:h-64 lg:h-80 bg-gray-200 dark:bg-muted rounded-2xl shadow-xl animate-pulse" />
          ...
          <div className="absolute top-4 right-4 sm:top-6 sm:right-6 flex gap-2 sm:gap-3">
            <div className="h-10 w-24 bg-gray-200 dark:bg-muted rounded-lg animate-pulse" />
            <div className="h-10 w-32 bg-gray-200 dark:bg-muted rounded-lg animate-pulse" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-16 sm:mt-20">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/80 dark:bg-card/80 backdrop-blur-sm rounded-2xl shadow-xl border-0 p-6">
              <div className="h-8 w-48 bg-gray-200 dark:bg-muted rounded animate-pulse mb-3" />
              <div className="h-5 w-32 bg-gray-200 dark:bg-muted rounded animate-pulse mb-4" />
              <div className="h-4 w-full bg-gray-200 dark:bg-muted rounded animate-pulse mb-2" />
              <div className="h-4 w-5/6 bg-gray-200 dark:bg-muted rounded animate-pulse mb-4" />
              <div className="h-4 w-40 bg-gray-200 dark:bg-muted rounded animate-pulse" />
            </div>
