...
export function SocialLinkCard({ link, onEdit, onDelete }: SocialLinkCardProps) {
  ...
  return (
    <div className="flex items-center justify-between p-3 border border-gray-200 dark:border-border rounded-lg hover:border-orange-300 transition-colors bg-gray-50 dark:bg-muted">
