        ...
        {links.map(link => {
          ...
          return (
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-2 bg-muted hover:bg-muted/80 border border-border rounded-lg transition-colors text-sm text-foreground hover:text-orange-600 dark:hover:text-foreground"
            >
