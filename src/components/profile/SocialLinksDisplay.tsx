...
export function SocialLinksDisplay({
  ...
  return (
    <div className={className}>
      {!compact && (
        <h4 className="text-sm font-semibold text-fg-primary mb-3">Social Media & Links</h4>
      )}
        ...
        {links.map(link => {
          ...
          return (
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-2 bg-surface-raised hover:bg-surface-raised/80 border border-default rounded-lg transition-colors text-sm text-fg-primary"
            >
