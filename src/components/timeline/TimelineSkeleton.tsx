        ...
        <div key={i} className="bg-card border border-border rounded-lg animate-pulse">
          <div className={`p-4 ${compact ? 'p-3' : 'p-4'}`}>
            <div className="flex items-start space-x-3">
              {/* Avatar skeleton */}
              <div
                className={`bg-gray-200 dark:bg-muted rounded-full flex-shrink-0 ${compact ? 'w-8 h-8' : 'w-10 h-10'}`}
              />

              <div className="flex-1 min-w-0">
                {/* Header skeleton */}
                <div className="flex items-center space-x-2 mb-2">
                  <div className="h-4 bg-gray-200 dark:bg-muted rounded w-24" />
                  <div className="h-3 bg-gray-200 dark:bg-muted rounded w-16" />
                  <div className="h-3 bg-gray-200 dark:bg-muted rounded w-12" />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-3 bg-gray-200 dark:bg-muted rounded w-8" />
                </div>
              </div>
            </div>
          </div>
