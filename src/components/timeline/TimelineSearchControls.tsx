      ...
      <form onSubmit={onSearch} className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-full border border-gray-200 dark:border-border bg-gray-50 dark:bg-muted py-2 pl-9 pr-3 text-sm dark:text-foreground dark:placeholder:text-muted-foreground focus:border-tiffany-400 focus:outline-none focus:ring-2 focus:ring-tiffany-100"
          />
        </div>
