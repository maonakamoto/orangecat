...
Last Modified Summary: WF-002 E2E credential SSOT; Dependabot overrides; workflow-matrix spec fixes.
...
| WF-002 | Auth/reset P0 checks      | P0 matrix skipped/blocked auth-dependent tests locally                               | P0       | Playwright specs used `E2E_TEST_USER_*` while CI matrix uses `E2E_USER_*`                                                                                                      | `tests/e2e/helpers/credentials.ts` SSOT + CI legacy aliases + matrix spec fixes                  | Closed (2026-07-04)                     |
