# OrangeCat Privacy Policy

**Last updated:** 2026-06-02
**Status:** TEMPLATE — review with counsel before publishing.

This Privacy Policy describes how OrangeCat ("we," "us," "our," or the "Service"), operated by Georgy Butaev (pending incorporation of a successor corporate entity), collects, uses, and shares your personal information when you use the Service.
...
- **Payment-related information:** Bitcoin wallet addresses, Lightning Network identifiers, payment metadata, and any payout or banking details you provide. We may use third-party payment processors; sensitive payment information may be handled directly by those processors.
...
- **Cookies and similar technologies:** session cookies, authentication tokens, preference cookies. See Section 8.
...
## 3. Bitcoin and Blockchain Transactions
...
- **Custody:** [SELECT ONE — review with counsel: (a) we are non-custodial: funds flow directly between buyer and seller wallets; we never hold user funds; OR (b) we operate an escrow service for the duration of a transaction; funds are held in our custody until the buyer confirms receipt].
...
You may request earlier deletion under Section 6, subject to legal retention obligations.
...
- **Delete** your personal information ("right to erasure"). Note: deletion does not affect data we are legally required to retain (transaction records, tax records, AML records) or data already published to public blockchain networks.
...
To exercise these rights, contact us at the address in Section 11. We will respond within 30 days.
...
**Georgy Butaev** (Data Controller, pending NewCo formation)
[ADDRESS]
...
_This template is not legal advice. Marketplace + cryptocurrency operations have significant jurisdiction-specific regulatory exposure (AML, KYC, money-transmitter licensing, consumer-protection law). Review with qualified counsel familiar with crypto and marketplace regulation before publishing._
