...
You assume all risks of transacting on the platform.

## 5. Listings and Acceptable Use

Sellers may not list, and buyers may not purchase:
...
- **Custody disclosure:** [SELECT ONE — review with counsel: (a) we are non-custodial: payments flow directly between buyer and seller wallets, and we never hold your funds; OR (b) we operate an optional escrow service that holds funds in our custody between confirmation of purchase and confirmation of delivery].
...
- Upon termination, your right to access the Service ceases. Sections 4, 6, 7, 10, 12, 16, 17, 18, and 20 survive termination.
...
_This template is not legal advice. Marketplace platforms transacting in Bitcoin face significant and rapidly evolving regulatory exposure (AML, KYC, money-transmitter licensing, securities law, consumer-protection law, tax reporting). Review thoroughly with qualified counsel before publishing or accepting any user. Jurisdictions where the Service is offered may impose mandatory provisions that override this template._
