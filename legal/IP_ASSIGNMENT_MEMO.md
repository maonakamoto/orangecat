...
- All source code, configuration, infrastructure-as-code, and build artifacts in the Cockpit and OrangeCat repositories and any successor or derivative repositories
...
- All trademarks, service marks, trade dress, and brand names (including the working title "Cockpit," the brand "OrangeCat," and any future renamings)
...
- I am the sole human author of the Work Product, except for AI-assisted contributions (notably from Anthropic's Claude models, which are work-for-hire output of my prompted instructions and to which I claim full authorship as the directing party)
- The Work Product does not knowingly incorporate code, designs, or other material from any prior employer, contractor, or other party that would constrain or impair the assignment contemplated herein
- All third-party dependencies (open-source libraries, services, fonts, images) are used under licenses compatible with proprietary commercial distribution, except where their licenses (e.g., LGPL on dynamically linked libraries) permit such use
- No party other than me holds any rights, lien, encumbrance, or claim against the Work Product

## 4. Future Assignment to NewCo

Upon formation of bitbaum AG and the relevant product subsidiary, I will execute a formal Assignment of Intellectual Property Rights agreement transferring all right, title, and interest in the Work Product to the appropriate entity (parent or subsidiary as determined by Swiss counsel). The intended structure is:
...
A copy of this memorandum is preserved:

- In each project repository at `legal/IP_ASSIGNMENT_MEMO.md`, with creation date evidenced by Git commit history (cryptographically signed where possible)
- (Optional) Time-stamped via OpenTimestamps or equivalent service for independent verification of the memo's existence as of the date above

## 6. Governing Law

This memorandum shall be construed under the laws of the Canton of Zurich, Switzerland, until such time as NewCo is formed, after which the governing law of NewCo's jurisdiction shall apply to the formal assignment.
...
_This memorandum is a unilateral declaration of intent by the Founder. It does not by itself effect a legal assignment but creates a documented paper trail of intent and authorship. Final assignment will occur via a separate written instrument at the time of NewCo formation. Consult counsel before relying on this document in any formal proceeding._
